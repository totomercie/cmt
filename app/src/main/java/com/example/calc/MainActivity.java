...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private BreakIterator solutionTextView;
    private BreakIterator solutionTextview;
    ...
    public void onClick(View view) {
        ...
        if (buttonText.equals("=")) {
            solutionTextview.setText(resultTextView);
        }
        ...
        String finalResult = getResultTextView(dataToCalculate);
    ...
    String getResultTextView(String data) {
        try {
